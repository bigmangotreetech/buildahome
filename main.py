...
def debit_note():
    ...
    if request.method == 'GET':
        ...
        bill_query = 'INSERT into wo_bills (project_id, contractor_name, contractor_code, contractor_pan, trade, stage, approval_2_amount, approved_on, work_order_id) values (%s,%s,%s,%s,%s,%s,%s,%s)'
